...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/chrisHa/Sites/personal/makersquare/thesis/artwlk/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(React); })(); } try { (function () {
	...
	var _HelloSection = __webpack_require__(229);

	var _HelloSection2 = _interopRequireDefault(_HelloSection);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'container' },
	        _react2['default'].createElement(_HelloSection2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// shams
	_Object$create = __webpack_require__(16)["default"];

	var _Object$freeze = __webpack_require__(38)["default"];
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  if (ExecutionEnvironment.canUseDOM && window.top === window.self) {
	    ...
	    // shims
	    Array.isArray, Array.prototype.every, Array.prototype.forEach, Array.prototype.indexOf, Array.prototype.map, Date.now, Function.prototype.bind, _Object$keys, String.prototype.split, String.prototype.trim, _Object$create, _Object$freeze];
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _Object$preventExtensions = __webpack_require__(48)["default"];
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  try {
	    ...
	    _Object$defineProperty({}, fragmentKey, { enumerable: false, value: true });
	  ...
	  create: function create(object) {
	    if ("production" !== process.env.NODE_ENV) {
	      ...
	      if (canWarnForReactFragment) {
	        var proxy = {};
	        _Object$defineProperty(proxy, fragmentKey, {
	          enumerable: false,
	          value: object
	        });
	        _Object$defineProperty(proxy, didWarnKey, {
	          writable: true,
	          enumerable: false,
	          value: false
	        });
	        ...
	        _Object$preventExtensions(proxy);
	        return proxy;
	      }
	    }
	    return object;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(13).Object.preventExtensions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol = __webpack_require__(62)['default'];

	var _Symbol$iterator = __webpack_require__(81)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(4),
	    ...
	    SUPPORT_DESC = __webpack_require__(66),
	    $def = __webpack_require__(11),
	    $redef = __webpack_require__(67),
	...
	if (!useNative) {
	  ...
	  if (SUPPORT_DESC && !__webpack_require__(80)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (name) {
	  return store[name] || (store[name] = Symbol && Symbol[name] || (Symbol || __webpack_require__(73))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyNames = __webpack_require__(76)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(10)('getOwnPropertyNames', function () {
	  return __webpack_require__(75).get;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(72)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $def($def.P + $def.F * __webpack_require__(89), NAME, methods);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(68)(IteratorPrototype, __webpack_require__(72)('iterator'), function () {
	  return this;
	});

	module.exports = function (Constructor, NAME, next) {
	  Constructor.prototype = $.create(IteratorPrototype, { next: __webpack_require__(69)(1, next) });
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var setUnscope = __webpack_require__(92),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  var defineDeprecationWarning = function defineDeprecationWarning(methodName, info) {
	    try {
	      _Object$defineProperty(ReactComponent.prototype, methodName, {
	        get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function instantiateReactComponent(node, parentCompositeType) {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    if (_Object$preventExtensions) {
	      _Object$preventExtensions(instance);
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  _warnIfContextsDiffer: function _warnIfContextsDiffer(ownerBasedContext, parentBasedContext) {
	    ...
	    var parentKeys = _Object$keys(parentBasedContext).sort();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(174);
	...
	var MobileSafariClickEventPlugin = __webpack_require__(181);
	var ReactBrowserComponentMixin = __webpack_require__(182);
	var ReactClass = __webpack_require__(109);
	var ReactComponentBrowserEnvironment = __webpack_require__(119);
	var ReactDefaultBatchingStrategy = __webpack_require__(184);
	var ReactDOMComponent = __webpack_require__(159);
	var ReactDOMButton = __webpack_require__(185);
	var ReactDOMForm = __webpack_require__(188);
	var ReactDOMImg = __webpack_require__(190);
	var ReactDOMIDOperations = __webpack_require__(120);
	var ReactDOMIframe = __webpack_require__(191);
	...
	var createFullPageComponent = __webpack_require__(221);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if (/[?&]react_perf\b/.test(url)) {
	      var ReactDefaultPerf = __webpack_require__(222);
...
/***/ function(module, exports, __webpack_require__) {
	...
	SyntheticEvent.augmentClass = function (Class, Interface) {
	  ...
	  var prototype = _Object$create(Super.prototype);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function startWatchingForValueChange(target, targetID) {
	  ...
	  activeElementValueProp = _Object$getOwnPropertyDescriptor(target.constructor.prototype, 'value');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function findDOMNode(componentOrElement) {
	  ...
	  "production" !== process.env.NODE_ENV ? invariant(componentOrElement.render == null || typeof componentOrElement.render !== 'function', 'Component (with keys: %s) contains `render` method ' + 'but is not mounted in the DOM', _Object$keys(componentOrElement)) : invariant(componentOrElement.render == null || typeof componentOrElement.render !== 'function');
	  "production" !== process.env.NODE_ENV ? invariant(false, 'Element appears to be neither ReactComponent nor DOMNode (keys: %s)', _Object$keys(componentOrElement)) : invariant(false);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoFocusMixin = __webpack_require__(186);
	var ReactBrowserComponentMixin = __webpack_require__(182);
	var ReactClass = __webpack_require__(109);
	var ReactElement = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getUnchangedComponents(measurement) {
	  ...
	  var cleanComponents = {};
	  var dirtyLeafIDs = _Object$keys(measurement.writes);
	  var allIDs = assign({}, measurement.exclusive, measurement.inclusive);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloSection = (function (_React$createClass) {
	  _inherits(HelloSection, _React$createClass);

	  function HelloSection() {
	    _classCallCheck(this, HelloSection);

	    _get(Object.getPrototypeOf(HelloSection.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(HelloSection, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	...
	exports['default'] = HelloSection;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/chrisHa/Sites/personal/makersquare/thesis/artwlk/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "HelloSection.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
